...
ifneq ($(PLEH_BUILD),)
include vendor/pleh/config/BoardConfigPleh.mk
endif
...
ifneq ($(PLEH_BUILD),)
ifneq ($(wildcard device/pleh/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/pleh/sepolicy/common/sepolicy.mk)
endif
endif
